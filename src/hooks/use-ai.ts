 ...
 */
export function useAI(directive: string, proposal: string, dao: string, options = {}) {
 ...
 */
export function useMultipleOpenAIResponses(directive: string, proposals: string[], options = {}) {
  const queryClient = useQueryClient();
