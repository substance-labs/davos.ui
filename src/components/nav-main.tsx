...
export function NavMain({
  ...
  const {
    isSubscribed,
    subscriptions: _subscriptions, // eslint-disable-line @typescript-eslint/no-unused-vars
  } = useSubscriptions();
            ...
            <SidebarMenuItem>
              <CollapsibleTrigger asChild>
                <SidebarMenuButton tooltip={item.title}>
                  ...
                  {item.title === 'Digest' ? (
                    <NavLink to="/digest/overview">{item.title}</NavLink>
                  ) : (
