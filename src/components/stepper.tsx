      ...
      Provider: ({
        ...
        return (
          <StepperContext.Provider value={{ variant, labelOrientation, tracking }}>
            <Scoped initialStep={initialStep} initialMetadata={domProps.initialMetadata}>
              <StepperContainer className={className} {...domProps}>
                {children}
              </StepperContainer>
            </Scoped>
...
const { Stepper: _Stepper, ..._rest } = defineStepper(...steps);

// 3. Export that real Stepper for your app to import
export const Stepper = _Stepper;
export type { _rest as StepperUtils };
